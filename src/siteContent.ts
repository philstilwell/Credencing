    ...
    [
      ...
      },
      {
        ...
        body: [
          ...
          'A good reading order is: the central framework paper, the glossary, the interactive archetypes, the case studies, and then the future-paper roadmap. That order moves from definition to diagnosis to application.',
        ],
      },
    ],
    [
